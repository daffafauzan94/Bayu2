...
{
    system("cls");
    gotoXY(1,1); cout << "Daffa Fauzan Hadiansyah 20051397024 2020B";
}
...
int main()
{
	...
	while(running)
	{
        gotoXY(20,8);  cout << "1) Menghitung Gaji Karyawan mingguan";
		gotoXY(20,9);  cout << "2) Menghitung Luas, Keliling, dan Sisi Miring Segitiga siku-siku";
